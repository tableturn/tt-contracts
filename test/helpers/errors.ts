...
export const MUST_BE_GOVERNOR_OR_AUTOMATON = 'This function must be called by a governor or an automaton.';
...
export const SELF_TERMINATION = 'Cannot self-destruct';
